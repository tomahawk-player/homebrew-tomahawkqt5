...
#    system "cmake -DQT_PLUGINS_DIR=#{qtpluginsdir}", ".", *std_cmake_args
    system "cmake -DQT_PLUGINS_DIR=/usr/local/Cellar/qt5/5.3.2/plugins . -DCMAKE_INSTALL_PREFIX=/usr/local/Cellar/qca/HEAD -DCMAKE_BUILD_TYPE=None -DCMAKE_FIND_FRAMEWORK=LAST -DWITH_OSSL_PLUGIN=yes -Wno-dev"
    system "make install"
  end
end
